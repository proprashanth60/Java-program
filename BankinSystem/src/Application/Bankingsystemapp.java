	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				Benificiary b = new Benificiary(beneficiaryID,customerID, name, accountNumber, bankDetails);
			...
			case 4:
				...
				Transaction t = new Transaction(accountID, ch, type, amount);
			...
			case 7:
				...
				break;
			case 8:
				for(Benificiary beneficiary:bankingService.getAllBeneficiaries())
					System.out.println(
							"Beneficiary ID: " + beneficiary.getBenificiaryid() + ", Name: " + beneficiary.getName());
				System.out.println("-------------------------------------");
				System.out.print("Customer Id : ");
				customerID = sc.nextInt();
				List<Benificiary> customerBeneficiaries = bankingService.getBeneficiariesByCustomerId(customerID);
				System.out.println("Beneficiaries for Customer ID :" + customerID);
				for (Benificiary beneficiary : customerBeneficiaries) {
					System.out.println(
							"Beneficiary ID: " + beneficiary.getBenificiaryid() + ", Name: " + beneficiary.getName());
				}
				break;
